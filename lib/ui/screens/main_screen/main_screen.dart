...
class _MainScreenContent extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final pageController = usePageController(initialPage: 3);
    return Scaffold(
      appBar: AppBar(),
      body: BlocListener<MainBloc, MainState>(
        listener: (context, state) {
          pageController.animateToPage(state.bottomNavigationBarIndex, duration: Duration(milliseconds: 500), curve: Curves.linear,);
        },
        child: PageView(
